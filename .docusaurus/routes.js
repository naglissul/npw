...
export default [
  ...
  {
    path: '/blog/2021/07/18/init',
    component: ComponentCreator('/blog/2021/07/18/init', 'dd8'),
    exact: true
  },
  {
    path: '/blog/2021/08/15/ideas-for-the-future',
    component: ComponentCreator('/blog/2021/08/15/ideas-for-the-future', 'ef7'),
    exact: true
  },
  {
    path: '/blog/2021/08/20/nothing-makes-sense',
    component: ComponentCreator('/blog/2021/08/20/nothing-makes-sense', '771'),
    exact: true
  },
  {
    path: '/blog/2021/08/26/trumpai-apie-rasyma',
    component: ComponentCreator('/blog/2021/08/26/trumpai-apie-rasyma', '290'),
    exact: true
  },
  {
  ...
  {
    path: '/blog/2025-01-...-mb-apskaita',
    component: ComponentCreator('/blog/2025-01-...-mb-apskaita', '6e3'),
    exact: true
  },
  {
    path: '/blog/2025/01/24/bett',
    component: ComponentCreator('/blog/2025/01/24/bett', '64f'),
    exact: true
  },
  {
  ...
  {
    path: '/blog/2025/02/01/all-uni',
    component: ComponentCreator('/blog/2025/02/01/all-uni', 'd68'),
    exact: true
  },
  {
    path: '/blog/2025/02/02/quhack',
    component: ComponentCreator('/blog/2025/02/02/quhack', 'ab6'),
    exact: true
  },
  {
  ...
  },
  {
    ...
    component: ComponentCreator('/blog/tags/activities', '32b'),
    exact: true
  },
  {
    path: '/blog/tags/activities/page/2',
    component: ComponentCreator('/blog/tags/activities/page/2', '3bb'),
    exact: true
  },
  {
    path: '/blog/tags/docs',
    component: ComponentCreator('/blog/tags/docs', '6f0'),
    exact: true
  },
  {
    path: '/blog/tags/en',
  ...
  {
    path: '/blog/tags/lt',
    component: ComponentCreator('/blog/tags/lt', '7ce'),
    exact: true
  },
  {
    path: '/blog/tags/lt/page/2',
    component: ComponentCreator('/blog/tags/lt/page/2', '408'),
    exact: true
  },
  {
    path: '/blog/tags/lt/page/3',
    component: ComponentCreator('/blog/tags/lt/page/3', 'aa8'),
    exact: true
  },
  {
        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/write/deafening-night',
                component: ComponentCreator('/docs/write/deafening-night', 'dad'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/write/other-snow',
                component: ComponentCreator('/docs/write/other-snow', '3cf'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/write/short-dreams',
                component: ComponentCreator('/docs/write/short-dreams', '717'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/write/slam/',
                component: ComponentCreator('/docs/write/slam/', '5fb'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/docs/write/the-last-year-snow',
                component: ComponentCreator('/docs/write/the-last-year-snow', '1ab'),
                exact: true,
                sidebar: "tutorialSidebar"
              }
            ]
